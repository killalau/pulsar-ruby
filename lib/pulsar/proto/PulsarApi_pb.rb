...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("PulsarApi.proto", :syntax => :proto2) do
    ...
    add_enum "pulsar.proto.Schema.Type" do
      ...
      value :LocalDate, 17
      value :LocalTime, 18
      value :LocalDateTime, 19
      value :ProtobufNative, 20
      value :AutoConsume, 21
      value :External, 22
    end
    add_message "pulsar.proto.MessageIdData" do
      ...
      repeated :ack_set, :int64, 5
      optional :batch_size, :int32, 6
      optional :first_chunk_message_id, :message, 7, "pulsar.proto.MessageIdData"
    end
    ...
    add_message "pulsar.proto.MessageMetadata" do
      ...
      optional :txnid_least_bits, :uint64, 22
      optional :txnid_most_bits, :uint64, 23
      optional :highest_sequence_id, :uint64, 24, default: 0
      optional :null_value, :bool, 25, default: false
      optional :uuid, :string, 26
      optional :num_chunks_from_msg, :int32, 27
      optional :total_chunk_msg_size, :int32, 28
      optional :chunk_id, :int32, 29
      optional :null_partition_key, :bool, 30, default: false
      repeated :compacted_batch_indexes, :int32, 31
      optional :schema_id, :bytes, 32
    end
    add_message "pulsar.proto.SingleMessageMetadata" do
      ...
      optional :null_value, :bool, 9, default: false
      optional :null_partition_key, :bool, 10, default: false
    end
    add_message "pulsar.proto.BrokerEntryMetadata" do
      optional :broker_timestamp, :uint64, 1
    ...
    add_message "pulsar.proto.CommandConnect" do
      ...
      optional :feature_flags, :message, 10, "pulsar.proto.FeatureFlags"
      optional :proxy_version, :string, 11
    end
    add_message "pulsar.proto.FeatureFlags" do
      optional :supports_auth_refresh, :bool, 1, default: false
      optional :supports_broker_entry_metadata, :bool, 2, default: false
      optional :supports_partial_producer, :bool, 3, default: false
      optional :supports_topic_watchers, :bool, 4, default: false
      optional :supports_get_partitioned_metadata_without_auto_creation, :bool, 5, default: false
      optional :supports_repl_dedup_by_lid_and_eid, :bool, 6, default: false
      optional :supports_topic_watcher_reconcile, :bool, 7, default: false
      optional :supports_scalable_topics, :bool, 8, default: false
    end
    add_message "pulsar.proto.CommandConnected" do
      ...
      optional :feature_flags, :message, 4, "pulsar.proto.FeatureFlags"
    end
    ...
    add_message "pulsar.proto.KeySharedMeta" do
      ...
      optional :allowOutOfOrderDelivery, :bool, 4, default: false
    end
    add_message "pulsar.proto.CommandSubscribe" do
      ...
      repeated :subscription_properties, :message, 18, "pulsar.proto.KeyValue"
      optional :consumer_epoch, :uint64, 19
    end
    ...
    add_message "pulsar.proto.CommandPartitionedTopicMetadata" do
      ...
      optional :metadata_auto_creation_enabled, :bool, 6, default: true
    end
    ...
    add_message "pulsar.proto.CommandLookupTopic" do
      ...
      optional :advertised_listener_name, :string, 7
      repeated :properties, :message, 8, "pulsar.proto.KeyValue"
    end
    ...
    add_message "pulsar.proto.CommandProducer" do
      ...
      optional :producer_access_mode, :enum, 10, "pulsar.proto.ProducerAccessMode", default: 0
      optional :topic_epoch, :uint64, 11
      optional :txn_enabled, :bool, 12, default: false
      optional :initial_subscription_name, :string, 13
    end
    add_message "pulsar.proto.CommandSend" do
      ...
      optional :is_chunk, :bool, 7, default: false
      optional :marker, :bool, 8, default: false
      optional :message_id, :message, 9, "pulsar.proto.MessageIdData"
    end
    ...
    add_message "pulsar.proto.CommandMessage" do
      ...
      repeated :ack_set, :int64, 4
      optional :consumer_epoch, :uint64, 5
    end
    ...
    add_message "pulsar.proto.CommandUnsubscribe" do
      required :consumer_id, :uint64, 1
      required :request_id, :uint64, 2
      optional :force, :bool, 3, default: false
    end
    ...
    add_message "pulsar.proto.CommandTopicMigrated" do
      required :resource_id, :uint64, 1
      required :resource_type, :enum, 2, "pulsar.proto.CommandTopicMigrated.ResourceType"
      optional :brokerServiceUrl, :string, 3
      optional :brokerServiceUrlTls, :string, 4
    end
    add_enum "pulsar.proto.CommandTopicMigrated.ResourceType" do
      value :Producer, 0
      value :Consumer, 1
    end
    add_message "pulsar.proto.CommandCloseProducer" do
      required :producer_id, :uint64, 1
      required :request_id, :uint64, 2
      optional :assignedBrokerServiceUrl, :string, 3
      optional :assignedBrokerServiceUrlTls, :string, 4
    end
    ...
    add_message "pulsar.proto.CommandRedeliverUnacknowledgedMessages" do
      ...
      optional :consumer_epoch, :uint64, 3
    end
    ...
    add_message "pulsar.proto.CommandProducerSuccess" do
      ...
      optional :topic_epoch, :uint64, 5
      optional :producer_ready, :bool, 6, default: true
    end
    ...
    add_message "pulsar.proto.CommandConsumerStatsResponse" do
      ...
      optional :messageAckRate, :double, 16
    end
    ...
    add_message "pulsar.proto.CommandGetLastMessageIdResponse" do
      ...
      required :request_id, :uint64, 2
      optional :consumer_mark_delete_position, :message, 3, "pulsar.proto.MessageIdData"
    end
    add_message "pulsar.proto.CommandGetTopicsOfNamespace" do
      ...
      optional :topics_pattern, :string, 4
      optional :topics_hash, :string, 5
      repeated :properties, :message, 6, "pulsar.proto.KeyValue"
    end
    ...
    add_message "pulsar.proto.CommandGetTopicsOfNamespaceResponse" do
      ...
      optional :filtered, :bool, 3, default: false
      optional :topics_hash, :string, 4
      optional :changed, :bool, 5, default: true
    end
    add_message "pulsar.proto.CommandWatchTopicList" do
      required :request_id, :uint64, 1
      required :watcher_id, :uint64, 2
      required :namespace, :string, 3
      required :topics_pattern, :string, 4
      optional :topics_hash, :string, 5
    end
    add_message "pulsar.proto.CommandWatchTopicListSuccess" do
      required :request_id, :uint64, 1
      required :watcher_id, :uint64, 2
      repeated :topic, :string, 3
      required :topics_hash, :string, 4
    end
    add_message "pulsar.proto.CommandWatchTopicUpdate" do
      required :watcher_id, :uint64, 1
      repeated :new_topics, :string, 2
      repeated :deleted_topics, :string, 3
      required :topics_hash, :string, 4
    end
    add_message "pulsar.proto.CommandWatchTopicListClose" do
      required :request_id, :uint64, 1
      required :watcher_id, :uint64, 2
    end
    add_message "pulsar.proto.SegmentInfoProto" do
      required :segment_id, :uint64, 1
      required :hash_start, :uint32, 2
      required :hash_end, :uint32, 3
      required :state, :enum, 4, "pulsar.proto.SegmentState"
      repeated :parent_ids, :uint64, 5
      repeated :child_ids, :uint64, 6
      required :created_at_epoch, :uint64, 7
      optional :sealed_at_epoch, :uint64, 8
      required :created_at_ms, :uint64, 9
      optional :sealed_at_ms, :uint64, 10
      optional :legacy_topic_name, :string, 11
    end
    add_message "pulsar.proto.SegmentBrokerAddress" do
      required :segment_id, :uint64, 1
      required :broker_url, :string, 2
      optional :broker_url_tls, :string, 3
    end
    add_message "pulsar.proto.ScalableTopicDAG" do
      required :epoch, :uint64, 1
      repeated :segments, :message, 2, "pulsar.proto.SegmentInfoProto"
      repeated :segment_brokers, :message, 3, "pulsar.proto.SegmentBrokerAddress"
      optional :controller_broker_url, :string, 4
      optional :controller_broker_url_tls, :string, 5
    end
    add_message "pulsar.proto.CommandScalableTopicLookup" do
      required :session_id, :uint64, 1
      required :topic, :string, 2
    end
    add_message "pulsar.proto.CommandScalableTopicUpdate" do
      required :session_id, :uint64, 1
      optional :dag, :message, 2, "pulsar.proto.ScalableTopicDAG"
      optional :error, :enum, 3, "pulsar.proto.ServerError"
      optional :message, :string, 4
      optional :resolved_topic_name, :string, 5
    end
    add_message "pulsar.proto.CommandScalableTopicClose" do
      required :session_id, :uint64, 1
    end
    add_message "pulsar.proto.ScalableAssignedSegment" do
      required :segment_id, :uint64, 1
      required :hash_start, :uint32, 2
      required :hash_end, :uint32, 3
      required :segment_topic, :string, 4
    end
    add_message "pulsar.proto.ScalableConsumerAssignment" do
      required :layout_epoch, :uint64, 1
      repeated :segments, :message, 2, "pulsar.proto.ScalableAssignedSegment"
    end
    add_message "pulsar.proto.CommandScalableTopicSubscribe" do
      required :request_id, :uint64, 1
      required :topic, :string, 2
      required :subscription, :string, 3
      required :consumer_name, :string, 4
      required :consumer_id, :uint64, 5
      required :consumer_type, :enum, 6, "pulsar.proto.ScalableConsumerType"
    end
    add_message "pulsar.proto.CommandScalableTopicSubscribeResponse" do
      required :request_id, :uint64, 1
      optional :error, :enum, 2, "pulsar.proto.ServerError"
      optional :message, :string, 3
      optional :assignment, :message, 4, "pulsar.proto.ScalableConsumerAssignment"
    end
    add_message "pulsar.proto.CommandScalableTopicAssignmentUpdate" do
      required :consumer_id, :uint64, 1
      required :assignment, :message, 2, "pulsar.proto.ScalableConsumerAssignment"
    end
    add_message "pulsar.proto.CommandWatchScalableTopics" do
      required :watch_id, :uint64, 1
      required :namespace, :string, 2
      repeated :property_filters, :message, 3, "pulsar.proto.KeyValue"
      optional :current_hash, :string, 4
    end
    add_message "pulsar.proto.ScalableTopicsSnapshot" do
      repeated :topics, :string, 1
    end
    add_message "pulsar.proto.ScalableTopicsDiff" do
      repeated :added, :string, 1
      repeated :removed, :string, 2
    end
    add_message "pulsar.proto.CommandWatchScalableTopicsUpdate" do
      required :watch_id, :uint64, 1
      optional :error, :enum, 4, "pulsar.proto.ServerError"
      optional :message, :string, 5
      oneof :event do
        optional :snapshot, :message, 2, "pulsar.proto.ScalableTopicsSnapshot"
        optional :diff, :message, 3, "pulsar.proto.ScalableTopicsDiff"
      end
    end
    add_message "pulsar.proto.CommandWatchScalableTopicsClose" do
      required :watch_id, :uint64, 1
    end
    ...
    add_message "pulsar.proto.CommandGetOrCreateSchema" do
      ...
      optional :producerName, :string, 4
    end
    ...
    add_message "pulsar.proto.CommandTcClientConnectRequest" do
      required :request_id, :uint64, 1
      required :tc_id, :uint64, 2, default: 0
    end
    add_message "pulsar.proto.CommandTcClientConnectResponse" do
      required :request_id, :uint64, 1
      optional :error, :enum, 2, "pulsar.proto.ServerError"
      optional :message, :string, 3
    end
    ...
    add_message "pulsar.proto.CommandEndTxnOnPartition" do
      ...
      optional :txnid_least_bits_of_low_watermark, :uint64, 6
    end
    ...
    add_message "pulsar.proto.BaseCommand" do
      ...
      optional :tcClientConnectRequest, :message, 62, "pulsar.proto.CommandTcClientConnectRequest"
      optional :tcClientConnectResponse, :message, 63, "pulsar.proto.CommandTcClientConnectResponse"
      optional :watchTopicList, :message, 64, "pulsar.proto.CommandWatchTopicList"
      optional :watchTopicListSuccess, :message, 65, "pulsar.proto.CommandWatchTopicListSuccess"
      optional :watchTopicUpdate, :message, 66, "pulsar.proto.CommandWatchTopicUpdate"
      optional :watchTopicListClose, :message, 67, "pulsar.proto.CommandWatchTopicListClose"
      optional :topicMigrated, :message, 68, "pulsar.proto.CommandTopicMigrated"
      optional :scalableTopicLookup, :message, 70, "pulsar.proto.CommandScalableTopicLookup"
      optional :scalableTopicUpdate, :message, 71, "pulsar.proto.CommandScalableTopicUpdate"
      optional :scalableTopicClose, :message, 72, "pulsar.proto.CommandScalableTopicClose"
      optional :scalableTopicSubscribe, :message, 73, "pulsar.proto.CommandScalableTopicSubscribe"
      optional :scalableTopicSubscribeResponse, :message, 74, "pulsar.proto.CommandScalableTopicSubscribeResponse"
      optional :scalableTopicAssignmentUpdate, :message, 75, "pulsar.proto.CommandScalableTopicAssignmentUpdate"
      optional :watchScalableTopics, :message, 76, "pulsar.proto.CommandWatchScalableTopics"
      optional :watchScalableTopicsUpdate, :message, 77, "pulsar.proto.CommandWatchScalableTopicsUpdate"
      optional :watchScalableTopicsClose, :message, 78, "pulsar.proto.CommandWatchScalableTopicsClose"
    end
    add_enum "pulsar.proto.BaseCommand.Type" do
      ...
      value :TC_CLIENT_CONNECT_REQUEST, 62
      value :TC_CLIENT_CONNECT_RESPONSE, 63
      value :WATCH_TOPIC_LIST, 64
      value :WATCH_TOPIC_LIST_SUCCESS, 65
      value :WATCH_TOPIC_UPDATE, 66
      value :WATCH_TOPIC_LIST_CLOSE, 67
      value :TOPIC_MIGRATED, 68
      value :SCALABLE_TOPIC_LOOKUP, 70
      value :SCALABLE_TOPIC_UPDATE, 71
      value :SCALABLE_TOPIC_CLOSE, 72
      value :SCALABLE_TOPIC_SUBSCRIBE, 73
      value :SCALABLE_TOPIC_SUBSCRIBE_RESPONSE, 74
      value :SCALABLE_TOPIC_ASSIGNMENT_UPDATE, 75
      value :WATCH_SCALABLE_TOPICS, 76
      value :WATCH_SCALABLE_TOPICS_UPDATE, 77
      value :WATCH_SCALABLE_TOPICS_CLOSE, 78
    end
    ...
    add_enum "pulsar.proto.ProducerAccessMode" do
      value :Shared, 0
      value :Exclusive, 1
      value :WaitForExclusive, 2
      value :ExclusiveWithFencing, 3
    end
    add_enum "pulsar.proto.ServerError" do
      ...
      value :NotAllowedError, 22
      value :TransactionConflict, 23
      value :TransactionNotFound, 24
      value :ProducerFenced, 25
    end
    ...
    add_enum "pulsar.proto.SegmentState" do
      value :ACTIVE, 0
      value :SEALED, 1
    end
    add_enum "pulsar.proto.ScalableConsumerType" do
      value :STREAM, 0
      value :CHECKPOINT, 1
    end
...
module Pulsar
  module Proto
    ...
    BrokerEntryMetadata = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.BrokerEntryMetadata").msgclass
    CommandConnect = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandConnect").msgclass
    FeatureFlags = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.FeatureFlags").msgclass
    ...
    CommandTopicMigrated = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandTopicMigrated").msgclass
    CommandTopicMigrated::ResourceType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandTopicMigrated.ResourceType").enummodule
    ...
    CommandWatchTopicList = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandWatchTopicList").msgclass
    CommandWatchTopicListSuccess = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandWatchTopicListSuccess").msgclass
    CommandWatchTopicUpdate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandWatchTopicUpdate").msgclass
    CommandWatchTopicListClose = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandWatchTopicListClose").msgclass
    SegmentInfoProto = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.SegmentInfoProto").msgclass
    SegmentBrokerAddress = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.SegmentBrokerAddress").msgclass
    ScalableTopicDAG = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.ScalableTopicDAG").msgclass
    CommandScalableTopicLookup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandScalableTopicLookup").msgclass
    CommandScalableTopicUpdate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandScalableTopicUpdate").msgclass
    CommandScalableTopicClose = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandScalableTopicClose").msgclass
    ScalableAssignedSegment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.ScalableAssignedSegment").msgclass
    ScalableConsumerAssignment = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.ScalableConsumerAssignment").msgclass
    CommandScalableTopicSubscribe = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandScalableTopicSubscribe").msgclass
    CommandScalableTopicSubscribeResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandScalableTopicSubscribeResponse").msgclass
    CommandScalableTopicAssignmentUpdate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandScalableTopicAssignmentUpdate").msgclass
    CommandWatchScalableTopics = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandWatchScalableTopics").msgclass
    ScalableTopicsSnapshot = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.ScalableTopicsSnapshot").msgclass
    ScalableTopicsDiff = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.ScalableTopicsDiff").msgclass
    CommandWatchScalableTopicsUpdate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandWatchScalableTopicsUpdate").msgclass
    CommandWatchScalableTopicsClose = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandWatchScalableTopicsClose").msgclass
    ...
    CommandTcClientConnectRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandTcClientConnectRequest").msgclass
    CommandTcClientConnectResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.CommandTcClientConnectResponse").msgclass
    ...
    ProducerAccessMode = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.ProducerAccessMode").enummodule
    ...
    SegmentState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.SegmentState").enummodule
    ScalableConsumerType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("pulsar.proto.ScalableConsumerType").enummodule
